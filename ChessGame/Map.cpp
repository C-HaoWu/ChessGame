...
void Map::setup()
{
	...
	int KnightEval[ROW_SIZE][COLUMN_SIZE] = {
		...
		{-40, -20, 0, 0, 0, 0, -20, -40},
		{-30, 0, 10, 1.5, 1.5, 10, 0, -30},
		{-30, 5, 1.5, 20, 20, 1.5, 5, -30},
		{-30, 0, 1.5, 20, 20, 1.5, 0, -30},
		{-30, 5, 10, 1.5, 1.5, 10, 5, -30},
		{-40, -20, 0, 5, 5, 0, -20, -40},
		{-50, -40, -30, -30, -30, -30, -40, -50} };
...
void Map::reverseArray(int white[ROW_SIZE][COLUMN_SIZE], int black[ROW_SIZE][COLUMN_SIZE])
{
	for (int i = 0; i < ROW_SIZE; i++) {
		for (int j = 0; j < COLUMN_SIZE; j++) {
